...
public:
  ...
  unsigned long getOperTime(int8_t id);
  unsigned long getOperTime(int8_t id, int *Hour, int *Min, int *Sec);
  int8_t getCounter(int8_t id);
  int8_t getEventType(int8_t id);
